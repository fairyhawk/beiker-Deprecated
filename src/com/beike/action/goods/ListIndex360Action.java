 ...
 */
@Controller
public class ListIndex360Action extends BaseUserAction {

	private static Log log = LogFactory.getLog(ListIndex360Action.class);
	...
	@RequestMapping("/goods/listIndex360.do")
	public Object searchListIndexGoods(ModelMap modelMap,
		...
		try {
			...
			if(!StringUtils.isBlank(city)&&!"shenyang".equals(city)&&!"fuzhou".equals(city)){
