...
public class IPSeeker {
	...
	static {
		map.put(PinyinUtil.hanziToPinyin("北京", ""), "北京");
		map.put(PinyinUtil.hanziToPinyin("上海", ""), "上海");
		map.put(PinyinUtil.hanziToPinyin("广州", ""), "广州");
		map.put(PinyinUtil.hanziToPinyin("深圳", ""), "深圳");
		map.put(PinyinUtil.hanziToPinyin("长沙", ""), "长沙");
		map.put(PinyinUtil.hanziToPinyin("济南", ""), "济南");
		map.put(PinyinUtil.hanziToPinyin("武汉", ""), "武汉");
		map.put(PinyinUtil.hanziToPinyin("重庆", ""), "重庆");
		map.put(PinyinUtil.hanziToPinyin("郑州", ""), "郑州");
		map.put(PinyinUtil.hanziToPinyin("杭州", ""), "杭州");
		map.put(PinyinUtil.hanziToPinyin("合肥", ""), "合肥");

		map.put(PinyinUtil.hanziToPinyin("沈阳", ""), "沈阳");
		map.put(PinyinUtil.hanziToPinyin("成都", ""), "成都");
		map.put(PinyinUtil.hanziToPinyin("天津", ""), "天津");

		map.put(PinyinUtil.hanziToPinyin("福州", ""), "福州");
		map.put(PinyinUtil.hanziToPinyin("南京", ""), "南京");
		map.put(PinyinUtil.hanziToPinyin("长春", ""), "长春");
		map.put(PinyinUtil.hanziToPinyin("南昌", ""), "南昌");
		map.put(PinyinUtil.hanziToPinyin("苏州", ""), "苏州");
		map.put(PinyinUtil.hanziToPinyin("厦门", ""), "厦门");
		map.put(PinyinUtil.hanziToPinyin("青岛", ""), "青岛");
		map.put(PinyinUtil.hanziToPinyin("西安", ""), "西安");
		map.put(PinyinUtil.hanziToPinyin("东莞", ""), "东莞");
//		map.put(PinyinUtil.hanziToPinyin("邯郸", ""), "邯郸");
	}
	static {
		for (Map.Entry<String, String> entry : map.entrySet()) {
			list.add(entry.getValue());
			pinyinList.add(entry.getKey());
		}
	}

	// 获得城市中文
	public static String getCityByStr(String city) {
		if (map != null && map.size() > 0) {

			String c = map.get(city);
			return c;
		}
		return null;
	}

	// private PropertyUtil propertyUtil = PropertyUtil
	// .getInstance("com.beike.util.ipparser.city");
	/**
	 * <pre>
	...
	// ClassLoader.getSystemResource("QQWry.dat").getPath();
	...
	private IPSeeker() {
		...
		try {
			...
			Resource r = loader.getResource("classpath:/QQWry.Dat");
			ipFile = new RandomAccessFile(r.getFile(), "r");
		} catch (Exception e) {
	...
	public String getCity(String ip) {
		...
		if (!"".equals(country)) {
			for (String listStr : list) {
				if (country.indexOf(listStr) != -1) {
					country = listStr;
					String cstr = PinyinUtil.hanziToPinyin(country, "");
					// String cstr=propertyUtil.getProperty(country);
	...
	public static void main(String[] args) {
		System.out.println(PinyinUtil.hanziToPinyin("长沙", ""));
	}
}